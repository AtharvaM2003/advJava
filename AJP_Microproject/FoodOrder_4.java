...
public class FoodOrder_4 extends JFrame{
	...
	FoodOrder_4(){
				...
				ta1.setBounds(500,220,100,100);
			 	 ...
			 	 ImageIcon i = new ImageIcon("A:/mp images/pizza.png");
			 	  l1 = new JLabel(i);
			 	  ...
			 	  ImageIcon i1 = new ImageIcon("A:/mp images/burger.png");
			 	  l2 = new JLabel(i1);
				  ...
				  ImageIcon i2 = new ImageIcon("A:/mp images/sandwich.png");
			 	   l3 = new JLabel(i2);
				  ...
				  ImageIcon i4 = new ImageIcon("A:/mp images/pasta.png");
			 	   l5 = new JLabel(i4);
				  ...
				  ImageIcon i5 = new ImageIcon("A:/mp images/rice.png");
			 	   l6 = new JLabel(i5);
				  ...
				  ImageIcon i6 = new ImageIcon("A:/mp images/Tomatosoup.png");
			 	   l7 = new JLabel(i6);
				  ...
				  bt7.addActionListener(new ActionListener(){  
						public void actionPerformed(ActionEvent e) {
							...
							JOptionPane.showMessageDialog(bt7,"Your Shipping Address:"+"\n"+a+"\n"+"Your Ordered items are:"+"\n"+b);
				  ...
				  p.add(ta1);	p.add(c);
				  p.add(l1);	 p.add(l2);	 p.add(l3);	  p.add(l5);	 p.add(l6);	 p.add(l7);
				  p.add(ta);	 p.add(l);
				  p.add(bt);	 p.add(bt1); p.add(bt2);		
				  p.add(bt4);	 p.add(bt5); p.add(bt6); p.add(bt7);
				  add(p);
